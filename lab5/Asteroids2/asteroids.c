...
1 = init start SINGLE
2 = init end SINGLE
4 = bullet task TOGGLE
8 = update task TOGGLE
16 = draw task TOGGLE
32 = reset TOGGLE
*/
...
int main(void) {
	DDRB = 0x00;
	TCCR2A = _BV(CS00); 
DDRA = 0xFF; // TODO remove test code
PORTA = 0xFF; // TODO rm test code	
